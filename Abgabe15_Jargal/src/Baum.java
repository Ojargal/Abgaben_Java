public class Baum {
    ...
    public Baum(String name, int alter, double hoehe, boolean krank, double durchmesser) {
        setName(name);
        setAlter(alter);
        setHoehe(hoehe);
    ...
    public void setDurchmesser(double durchmesser) {
        if (durchmesser > 0 && durchmesser < hoehe / 10) {
            ...
            System.out.println("Fehler: Ungültiger Wert für Durchmesser. Standardwert wird gesetzt.");
